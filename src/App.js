    ...
    return (
        <div>
            ...
            <div className='container-fluid'>
                ...
                <section id= "s1" className='section  pr-0  row justify-content-around mt-3'>
                    <div className='col-12 col-sm-6 col-md-8 '>
                        <h2 className='sTitle mt-2'>
                    ...
                    <div className='col-6 col-md-4  mt-5'>
                        <img className='img-thumbnail ' src={head}/>
                    </div>
                </section>


                <section id= "s2" className='section  pr-0  row justify-content-around mt-3'>
                    <div className='col-12 col-sm-6 col-md-8 '>
                        <h2 className='sTitle  mt-2'>
                            La technologie
                        </h2>
                ...
                <section id= "s3" className='section  pr-0  row justify-content-around mt-3'>
                    <div className='col-12 col-sm-6 col-md-8 '>
                        <h2 className='sTitle mt-2'>
                            La puce GT2100
                        </h2>
                ...
                <section id= "s4" className='section  pr-0  row justify-content-around mt-3'>
                    <div className='col-12 col-sm-6 col-md-8 '>
                        <h2 className='sTitle mt-2'>
                ...
                <section id= "s5" className='section  pr-0  row justify-content-around mt-3'>
                    <div className='col-12 col-sm-6 col-md-8 '>
                        <h2 className='sTitle mt-2'>
                ...
                <section id= "s6" className='section  pr-0  row justify-content-around mt-3'>
                    <div className='col-12 col-sm-6 col-md-8 '>
                        <h2 className='sTitle mt-2'>
                ...
                <section id= "s7" className='section  pr-0  row justify-content-around mt-3'>
                    <div className='col-12 col-sm-6 col-md-8 '>
                        <h2 className='sTitle mt-2'>
